...
// Add RV
loadExtraModel('BREAKING BAD RV.glb', new THREE.Vector3(0, 0.01, -5), Math.PI);

// Add Jesse Pinkman
loadExtraModel('JESSE PINKMAN.glb', new THREE.Vector3(-1.5, 0, -5));

// Add Walter White
loadExtraModel('WALTER WHITE.glb', new THREE.Vector3(1.5, 0, -5));
			},
