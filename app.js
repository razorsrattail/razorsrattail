...
// Add RV
loadExtraModel('BREAKING BAD RV.glb', new THREE.Vector3(0, 0, -2), Math.PI);

// Add Jesse Pinkman
loadExtraModel('JESSE PINKMAN.glb', new THREE.Vector3(-2, 0, -2));

// Add Walter White
loadExtraModel('WALTER WHITE.glb', new THREE.Vector3(2, 0, -2));
			},
